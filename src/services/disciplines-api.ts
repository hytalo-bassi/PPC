 ...
 * });
 */
export async function pegarSemestralizacao(codigo: number): Promise<Array<Array<Discipline>>> {
 ...
 */
export async function pegarDisciplinas(codigo: number): Promise<Array<Discipline>> {
  const disciplinas = [];
  const dados = await load_json(codigo);
 ...
 */
export async function pegarSemestralizacaoLista(codigo: number): Promise<{ semestres: Array<Array<Discipline>>, disciplinas: Array<Discipline> }> {
  let semestres: Array<Array<Discipline>> = [];

<template>
  <header class="flex items-center py-4 bg-white/10 px-2 ">
    <h1 class="flex flex-row items-center gap-x-2 text-sm font-medium text-primary">
      <svg class="logo-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <a class="underline" href="https://github.com/hytalo-bassi/PPC" target="_blank" rel="noopener noreferrer">
        hytalo-bassi/PPC
      </a>
    </h1>
    <div

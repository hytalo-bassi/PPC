  ...
  >
    <header class="flex flex-col text-center justify-center w-full py-12">
      <div class="Header_Content">
        <h1 class="text-4xl font-semibold pb-2">
          Quadro de Semestralização e Pré-Requisitos
        </h1>
      </div>
      <div
        class="mx-auto flex flex-row border bg-[rgb(0,0,0,0.2)] w-min p-2 rounded-lg border-[rgb(255,255,255,0.5)] items-center gap-2"
      >
        <span>Buscar</span>
        <input
          v-model="inputValue"
